            ...
            <div className="sidebar" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
                ...
                <div className="allschool">
                    ...
                    <Link to="/" className="sidebar-link">
                        <img width="48" height="48" src="https://img.icons8.com/pulsar-color/48/school-building.png" alt="홈"/>
                        <span className="link-text"> 홈</span>
                    </Link>
                    <Link to="/mypage" className="sidebar-link">
                        <img width="48" height="48" src="https://img.icons8.com/pulsar-color/48/noticeboard.png" alt="내 페이지"/>
                        <span className="link-text"> 내 페이지</span>
                    </Link>
                    <div className="sidebar-link project-link" onClick={toggleProjectExpand}>
                        <img width="48" height="48" src="https://img.icons8.com/pulsar-color/48/collaborating-in-circle.png" alt="프로젝트"/>
                    ...
                    <Link to="/chat" className="sidebar-link">
                        <img width="48" height="48" src="https://img.icons8.com/pulsar-color/48/chat-message-sent.png" alt="채팅"/>
                        <span className="link-text"> 채팅</span>
                    </Link>
                    <Link to="/calendar" className="sidebar-link">
                        <img width="48" height="48" src="https://img.icons8.com/pulsar-color/48/000000/edit-calendar.png" alt="달력"/>
