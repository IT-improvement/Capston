        ...
        <div className="additional-line">
            ...
            <article className="artclon">
                <div className="feed">
                        ...
                        <div className="id_round">
                            <div className="id_box">
                                <div className="id_box_img">
                                    <img className="id_img" src="/resources2/img/picture8.png"
                                         alt="내 프로필"/>
                                </div>
                    ...
                    <div className="feed_picture">
                        <img src="/resources2/img/p4.jpg" alt="피드 사진"/>
                    </div>
                        ...
                        <div className="emoticon_box">
                            <div className="emoticon_box2">
                                ...
                                <div className="comment_box">
                                    <img className="coment" src="/resources2/img/comment.png"
                                         alt="코멘트"/>
                                </div>
                                <div className="direct_box">
                                    <img className="direct" src="/resources2/img/direct.png"
                                         alt="종이비행기"/>
                                </div>
                            </div>
                    ...
                    <div className="feed_like_box">
                        <div className="feed_like_picture">
                            <img className="feed_like_peolpe" src="/resources2/img/picture8.png"
                                 alt="세원"/>
                        </div>
            ...
            <article>
                <div className="feed">
                    ...
                    <div className="feed_picture">
                        <img src="/resources2/img/p5.jpg" alt="피드 사진"/>
                    </div>
